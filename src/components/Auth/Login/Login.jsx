    ...
    <div className="min-h-screen bg-[#FAF8F5] pt-28 pb-16 px-4 flex flex-col items-center justify-center relative overflow-hidden selection:bg-[#4D7C5D]/20 font-poppins">
      ...
      <div className="w-full max-w-4xl bg-white/35 dark:bg-black/15 backdrop-blur-2xl rounded-3xl border border-white/30 shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden grid grid-cols-1 md:grid-cols-12 min-h-162.5 relative z-10">
        ...
        <div className="md:col-span-5 bg-gradient-to-b from-[#C9D6EA]/60 to-[#4D7C5D]/90 p-8 flex flex-col justify-between relative text-white">
          ...
          <div className="relative z-10 space-y-3">
            <h3 className="text-2xl font-bold font-serif leading-tight tracking-wide">
              &ldquo;Welcome back to your space of clarity.&rdquo;
            </h3>
            <p className="text-xs text-white/90 leading-relaxed font-normal">
              Continue mapping your personal growth and lessons.
            </p>
          </div>
        </div>
        ...
        <div className="md:col-span-7 p-8 md:p-10 flex flex-col justify-center">
          ...
          <form className="space-y-5" onSubmit={handleEmailLogin}>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link href="/auth/forgot-password" className="text-[11px] font-semibold text-[#2D6A4F] hover:underline">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center">
              <input id="remember-me" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-[#4D7C5D] focus:ring-[#4D7C5D]/30 accent-[#4D7C5D]" />
              <label htmlFor="remember-me" className="ml-2 text-xs text-gray-500 font-normal select-none">
          ...
          {/* Redirection link */}
          <p className="text-center text-xs text-gray-500 font-normal mt-6">
            Don&apos;t have an account yet?{" "}
            <Link href="/auth/signup" className="text-[#2D6A4F] font-bold hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
